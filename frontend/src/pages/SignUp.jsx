    ...
    <Layout>
      ...
      <div className="w-full pt-5">
        ...
        <section className="w-full px-4 py-16">
          <div className="max-w-5xl mx-auto bg-white/5 backdrop-blur-sm p-8 rounded-xl shadow-xl border border-emerald-800/30">
            <h1 className="text-4xl font-bold text-white mb-2 text-center">Create Your Account</h1>
            <p className="text-emerald-200 text-center mb-10 text-lg">Join thousands of businesses using WhatsBulk to connect with customers</p>
            
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* First Name */}
                <div>
                  <label htmlFor="firstName" className="block text-sm font-medium text-emerald-200 mb-2">First Name</label>
                  <input
                    type="text"
                    id="firstName"
                    name="firstName"
                ...
                {/* Last Name */}
                <div>
                  <label htmlFor="lastName" className="block text-sm font-medium text-emerald-200 mb-2">Last Name</label>
                  <input
                    type="text"
                    id="lastName"
                    name="lastName"
              ...
              {/* Password */}
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-emerald-200 mb-2">Password</label>
                <input
                  type="password"
                  id="password"
                  name="password"
                ...
                />
                <p className="text-emerald-300 text-xs mt-2">Password must be at least 8 characters and include one uppercase letter, number, and special character</p>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Company Name */}
                <div>
                  <label htmlFor="companyName" className="block text-sm font-medium text-emerald-200 mb-2">Company Name</label>
                  <input
                    type="text"
                    id="companyName"
                    name="companyName"
                ...
                {/* Phone Number */}
                <div>
                  <label htmlFor="phoneNumber" className="block text-sm font-medium text-emerald-200 mb-2">Phone Number</label>
                  <input
                    type="tel"
                    id="phoneNumber"
                    name="phoneNumber"
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="agreeToTerms" className="text-emerald-200">
                    I agree to the <Link to="/terms" className="text-emerald-400 hover:text-emerald-300 underline">Terms of Service</Link> and <Link to="/privacy" className="text-emerald-400 hover:text-emerald-300 underline">Privacy Policy</Link>
                  </label>
                </div>
              </div>
            ...
            <div className="mt-10">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-emerald-950/80 text-emerald-200">Or sign up with</span>
                </div>
              </div>
              
              <div className="mt-6 grid grid-cols-2 gap-6">
                <button className="w-full inline-flex justify-center py-3 px-4 border border-emerald-800/30 rounded-lg bg-white/5 hover:bg-white/10 text-white font-medium transition-colors transform hover:scale-101 transition-transform">
        ...
        <section className="w-full px-4 py-12 mb-16">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-emerald-800/20 hover:bg-white/8 transition-colors">
              <div className="bg-emerald-600 w-14 h-14 rounded-full flex items-center justify-center mb-5 shadow-lg">
