...
// Using the same icon components from the dashboard
                ...
                return (
                    <div className="space-y-6">
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                className="w-full p-4 pl-10 bg-green-800/20 border border-green-800/30 rounded-lg text-white placeholder-green-300 focus:outline-none focus:ring-2 focus:ring-green-500"
                            ...
                            <div className="space-y-4">
                                ...
                                {filteredFAQs.length > 0 ? (
                                    filteredFAQs.map((faq, index) => (
                                        <div key={index} className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-green-800/20">
                                            <div className="text-green-200 text-sm mb-1">{faq.category}</div>
                                            <h3 className="text-white font-medium text-lg mb-2">{faq.question}</h3>
                                            <p className="text-green-100">{faq.answer}</p>
                                        </div>
                                    ))
                                ) : (
                                    <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-green-800/20 text-center">
                                        <p className="text-green-100">No results found. Try a different search term or browse our categories below.</p>
                                    </div>
                                )}
                            </div>
                        ) : (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {videoTutorials.map((video) => (
                                <div key={video.id} className="bg-white/5 backdrop-blur-sm rounded-xl border border-green-800/20 overflow-hidden">
                                    <div className="relative">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {knowledgeBaseArticles.map((article) => (
                                <div key={article.id} className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-green-800/20">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <span className="text-green-300 text-xs">{article.readTime}</span>
                                    </div>
                                    <div className="mt-4">
                                        <button className="text-green-400 hover:text-green-300 text-sm font-medium">Read Article →</button>
                                    </div>
                                </div>
                            ))}
                        </div>
                        <div className="text-center">
                            <button className="inline-flex items-center text-green-400 hover:text-green-300 font-medium">
                                View all articles
                ...
                return (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-green-800/20 text-center">
                                <div className="w-12 h-12 bg-green-800/40 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <ChatIcon />
                                </div>
                                <h3 className="text-white font-medium mb-2">Live Chat</h3>
                                <p className="text-green-100 mb-4">Talk to our support team in real-time</p>
                                <button className="w-full bg-green-600 hover:bg-green-500 text-white py-2 px-4 rounded-lg transition-colors font-medium">
                                    Start Chat
                                </button>
                                <p className="text-green-300 text-sm mt-2">Available 24/7</p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-green-800/20 text-center">
                                ...
                                <p className="text-green-100 mb-4">Send us a message and we'll respond within 24 hours</p>
                                <button className="w-full bg-green-600 hover:bg-green-500 text-white py-2 px-4 rounded-lg transition-colors font-medium">
                                    Send Email
                                </button>
                                <p className="text-green-300 text-sm mt-2">support@whatsbulk.com</p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-green-800/20 text-center">
                                ...
                                <p className="text-green-100 mb-4">Schedule a call with a product specialist</p>
                                <button className="w-full bg-green-600 hover:bg-green-500 text-white py-2 px-4 rounded-lg transition-colors font-medium">
                                    Schedule Call
                                </button>
                                <p className="text-green-300 text-sm mt-2">Business hours: 9AM-5PM EST</p>
                            </div>
                        </div>

                        <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-green-800/20">
                            <h3 className="text-white font-medium mb-4">Submit a Support Ticket</h3>
                            <form className="space-y-4">
                                <div>
                                    <label htmlFor="name" className="block text-green-100 mb-1">Your Name</label>
                                    <input
                                        type="text"
                                        id="name"
                                        className="w-full p-3 bg-green-800/20 border border-green-800/30 rounded-lg text-white placeholder-green-300 focus:outline-none focus:ring-2 focus:ring-green-500"
                                        placeholder="Enter your name"
                                    />
                                </div>
                                <div>
                                    <label htmlFor="email" className="block text-green-100 mb-1">Email Address</label>
                                    <input
                                        type="email"
                                        id="email"
                                        className="w-full p-3 bg-green-800/20 border border-green-800/30 rounded-lg text-white placeholder-green-300 focus:outline-none focus:ring-2 focus:ring-green-500"
                                ...
                                <div>
                                    <label htmlFor="issue" className="block text-green-100 mb-1">Issue Type</label>
                                    <select
                                        id="issue"
                                        className="w-full p-3 bg-green-800/20 border border-green-800/30 rounded-lg text-white placeholder-green-300 focus:outline-none focus:ring-2 focus:ring-green-500"
                                    >
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-green-100 mb-1">Your Message</label>
                                    <textarea
                                        id="message"
                                        rows="4"
                                        className="w-full p-3 bg-green-800/20 border border-green-800/30 rounded-lg text-white placeholder-green-300 focus:outline-none focus:ring-2 focus:ring-green-500"
                                ...
                                <div>
                                    <button type="submit" className="w-full bg-green-600 hover:bg-green-500 text-white py-3 px-4 rounded-lg transition-colors font-medium">
                                        Submit Ticket
                                    </button>
                                </div>
                            </form>
                ...
                <div className="relative flex-1 flex flex-col min-h-0 overflow-y-auto">
                    <div className="flex-1 px-2 space-y-1">
                        ...
                        <div className="pt-4 mt-4 border-t border-green-800/30">
                            ...
                            {/* Help & Support */}
                            <Link to="/help" className="text-white flex items-center px-4 py-3 rounded-lg bg-green-800/40 group">
                                <HelpIcon />
            ...
            <main className={`pt-16 ${sidebarOpen ? "lg:ml-64" : "lg:ml-20"} transition-all duration-300`}>
                <div className="px-4 py-6">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-green-200 mt-2">Find answers to your questions, watch tutorials, or contact our support team</p>
                    </div>

                    {/* Tabs */}
                    <div className="flex space-x-4 mb-8 border-b border-green-800/30">
                        <button
